/*
Create a class person with name and date of birth as data members. Ask the user to enter a date
 of birth and print all persons name with a matched date of birth.
*/
...
{	
	...
	cin >> n;
	Person *p1;
	p1 = new Person[n]; //dynamic memory allocate
	for(int i=0; i<n; ++i)
	{
		p1[i].getInfo();
	}
